...
def main():
    ...
    print("=" * 70)
    print()
    print("NOTE: Both C and Python converters now output decimal notation.")
    print("      C adds trailing zeros (e.g., 0.g000...), Python doesn't (e.g., 0.g)")
    print("      Both formats are mathematically equivalent.")
    print()
    print("This test validates functional alignment by:")
    print("  1. Comparing 32TO10 outputs (should match numerically)")
    print("  2. Testing round-trip conversions (10->32->10)")
    print()
    
    # Test 1-10: Base-10 to Base-32 conversions
    print("10TO32 Tests (Base-10 to Base-32):")
    print("-" * 70)
    print("(Skipping exact format comparison - C adds trailing zeros)")
    print()
