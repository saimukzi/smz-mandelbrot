...
echo -e "CAL 128 1.v@0 0 0 0 10 2\nEXIT" | ./mandelbrot
echo ""

echo "Test 4: Very small numbers"
echo "----------------------------------------"
echo "c = (0.000001, 0.000001)"
echo -e "CAL 128 0 0 1@-6 1@-6 1000 2\nEXIT" | ./mandelbrot
echo ""
...
echo -e "CAL 128 -1 -1 -0.8@0 0.8@0 100 2\nEXIT" | ./mandelbrot
echo ""

echo "Test 7: Different escape radius (R = 10)"
echo "----------------------------------------"
echo -e "CAL 64 0 0 0 0 100 a@1\nEXIT" | ./mandelbrot
echo ""

echo "Test 8: Different escape radius (R = 1.5)"
echo "----------------------------------------"
echo -e "CAL 64 0 0 0 0 100 1.8@0\nEXIT" | ./mandelbrot
echo ""
...
echo -e "CAL 128 0 0 -0.o@0 0 1000 2\nEXIT" | ./mandelbrot
echo ""

echo "Test 12: Point on boundary"
echo "----------------------------------------"
echo "Point: c = (-0.5, 0.5) - near boundary"
echo -e "CAL 256 0 0 -0.g@0 0.g@0 10000 2\nEXIT" | ./mandelbrot
echo ""
...
echo "10 iterations:"
echo -e "CAL 128 0 0 -0.5@0 0.5@0 10 2\nEXIT" | ./mandelbrot
echo "100 iterations:"
echo -e "CAL 128 0 0 -0.5@0 0.5@0 100 2\nEXIT" | ./mandelbrot
echo "1000 iterations:"
echo -e "CAL 128 0 0 -0.5@0 0.5@0 1000 2\nEXIT" | ./mandelbrot
echo ""
